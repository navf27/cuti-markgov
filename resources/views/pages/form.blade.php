        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <span>When attempting to submit, you’ll see the <code class="text-danger">:invalid
                        </code> and <code class="text-danger">:valid </code> styles applied to your
                        form controls.</span>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <span>
                        ...
                        submitting the form below. Depending on your browser and OS,
                        you’ll see a slightly different style of feedback.
                    </span>
                    <span>While these feedback styles cannot be styled with CSS, you can still customize
                        the feedback text through JavaScript.</span>
                </div>
                <div class="card-body">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="validationDefaultUsername"
                                        type="text" placeholder="Username"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control" id="validationDefault05"
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <div class="checkbox p-0">
                                    <input class="form-check-input" id="invalidCheck2"
                                        type="checkbox" required="" />
                                    <label class="form-check-label" for="invalidCheck2">Agree to
                ...
                <div class="card-body">
                    <form class="was-validated">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" id="validationFormCheck1"
                                type="checkbox" required="" />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="validationFormCheck2"
                                type="radio" name="radio-stacked" required="" />
            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <span>
                        ...
                        validation feedback
                        in a styled tooltip. Be sure to have a parent with <code
                            class="text-danger">position: relative</code> on it for tooltip
                        positioning. In the example below, our column classes have this already, but
                        your project may
                    ...
                    <form class="row g-3 needs-validation" novalidate="">
                        ...
                        <div class="col-md-4 position-relative">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input class="form-control" id="validationTooltipUsername"
                                    type="text"
