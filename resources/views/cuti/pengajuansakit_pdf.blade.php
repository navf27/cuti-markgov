...
<html lang="">
    ...
    <body>
        ...
        <div class="text-center mb-1">
            ...
            <p>No: {{$pengajuansakit->no_surat ?? '-'}}</p>
        </div>
        <div class="container-fluid">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->pegawai->nama_depan}} {{$pengajuansakit->pegawai->nama_belakang}}</div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 25%">
                        <div class="text-start ml-5 mb-3">Jabatan {{$pengajuansakit->pegawai->user->role_name}}</div>
                    </td>
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->pegawai->user->role_name}}</div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 25%">
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->pegawai->divisi->nama_divisi}}</div>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->kategori_cuti}}</div>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->tgl_awal_cuti}} s/d. {{$pengajuansakit->tgl_akhir_cuti}}</div>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->lama_cuti}} hari</div>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->keterangan}}</div>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <div class="text-start ml-5 mb-3">: {{$pengajuansakit->sisa_cuti}}</div>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <!-- {{$pengajuan->kategori == 1 || $pengajuan->kategori == null ? $pengajuan->lama_cuti : '-'}} -->
                        <div class="text-start ml-5 mb-3">:{{$pengajuansakit->lama_cuti}}</div>
                    </td>
                    <td>
                        <div class="text-start ml-5 mb-3"> hari</div>
                    </td>
            ...
            <div class="text-start">Surabaya, {{$pengajuansakit->tgl_dibuat}}</div>
            <div class="text-start">Hormat saya <br><img src="data:image/png;base64, {!! $pengajuansakit->qr_pengaju !!}"></div>

            <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="text-start">{{$pengajuansakit->pegawai->nama_depan}} {{$pengajuansakit->pegawai->nama_belakang}}</div>
                            <div class="text-start">Mengetahui</div> 
                            @if ($pengajuansakit->status == '1')
                            <img src="data:image/png;base64, {!! $pengajuansakit->qr_direktur !!}">
                            <div class="text-start mb-3">{{$pengajuansakit->mengetahui}}</div>
                            @else
                            <br><br><br><br>
                        ...
                        <td style="padding-left: 20%">
                            ...
                            @if ($pengajuansakit->acc_kepala == '1')
                            <img src="data:image/png;base64, {!! $pengajuansakit->qr_kepala !!}">
                            <div class="text-start mb-3">{{$pengajuansakit->menyetujui}}</div>
                            @else
                            <br><br><br><br>
                            <div class="text-start mb-3">........................................................</div>
                            @endif
